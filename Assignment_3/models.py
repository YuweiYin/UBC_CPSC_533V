...
class Network(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        self.lin_in = nn.Linear(in_dim, 200)
        self.lin_out = nn.Linear(200, out_dim)
        ...
        self.lin_out.bias.data.fill_(0.0)
...
class ActorCritic(nn.Module):
    ...
    See Sutton book (https://www.andrew.cmu.edu/course/10-703/textbook/BartoSutton.pdf) Chapter 13
        for discussion of Actor Critic methods. Basically they are just policy gradients methods
        where you also learn a value function and use that to aid in learning.
    Not all options in this class use a critic, for example psi_mode="future_return"
        just uses the rewards in a REINFORCE fashion.
    """
    ...
    def step(self, obs):
        ...
        # no_grad, since we do not need to do any backprop while we collect data.
