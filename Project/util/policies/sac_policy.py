...
from ..infrastructure.sac_utils import SquashedNormal
...
class MLPPolicySAC(MLPPolicy):
    ...
    # `torch.distributions.Distribution` object. It is up to you!
    def forward(self, observation: torch.FloatTensor):
        # Implement pass through network, computing logprobs and apply correction for Tanh squashing
        # HINT: You will need to clip log values; You will need SquashedNormal from sac_utils file
        if self.discrete:
    ...
    def update(self, obs, critic, **kwargs):
        ...
        # actor_loss = - torch.mean(self.alpha.detach() * action_log_prob - min_Q)  # TODO
